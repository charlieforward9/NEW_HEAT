...
const SEQUENTIAL_DATA_URL =
  "https://raw.githubusercontent.com/charlieforward9/animated_heatmap/master/data/2022.json";
const BULK_DATA_URL =
  "https://raw.githubusercontent.com/charlieforward9/animated_heatmap/master/data/2022bulk.json";
const RANDOM_DATA_URL =
  "https://raw.githubusercontent.com/charlieforward9/animated_heatmap/master/data/2022randombulk.json";
...
document
  ...
  .addEventListener("click", (e: Event) => reset());

const delay = (ms: number) => new Promise((res) => setTimeout(res, ms));

function initMap(): void {
  document
    .getElementById("sequenceAnimate")!
    .addEventListener("click", (e: Event) => viewportAnimate(0));
  document
    .getElementById("bulkAnimate")!
    .addEventListener("click", (e: Event) => viewportAnimate(1));
  document
    .getElementById("randAnimate")!
    .addEventListener("click", (e: Event) => viewportAnimate(2));
  document
    .getElementById("normAnimate")!
    .addEventListener("click", (e: Event) => viewportAnimate(4));
  ...
  function _sequentialAnimation(): void {
    ...
    if (currentTime < 3500000) {
      ...
      //Irving Texas
      map.panTo({ lat: 32.914, lng: -96.9489 });
      map.setZoom(zoom + 0.01);
      ...
      //FloRida 2
      map.panTo({ lat: 28.292, lng: -81.4076 });
      map.setZoom(zoom - 0.05);
